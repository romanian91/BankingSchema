#   Copyright To Danaram and Sahil Solanki
#Just enter number of player and size of box and just make some fun
from Tkinter import *
import tkFont
import tkMessageBox
import sys
...
class MyFrame(Frame):
    def __init__(self, master):
        ...
        self.GO_font = tkFont.Font(self, \
                                   ...
                                   weight="bold", \
                                   size=36)
        self.canvas = Canvas(self, height = GAME_H, width = GAME_W,bg="yellow")
        ...
        self.infoframe.players = [Label(self.infoframe, textvariable = i.str,bg="cyan",height=2,width=50) for i in self.players]
